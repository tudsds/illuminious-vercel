      ...
      <div className="container mx-auto px-4 lg:px-8 py-16">
            ...
            <Link href="/" className="flex items-center gap-3 mb-6">
              ...
              <span
                className={`text-xl font-bold ${
                  isStartupsPage ? "text-cyan-400" : "text-white"
                }`}
              >
                illuminious
              </span>
              ...
              <a
                ...
                className={`p-2 rounded-full transition-colors ${
                  isStartupsPage
                    ...
                    : "bg-blue-600/20 text-white hover:bg-blue-600/40"
                }`}
              >
              ...
              {globalOffices.map((office) => (
                <li key={office.location} className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className={`text-xs ${isStartupsPage ? "text-cyan-400/70" : "text-white/60"}`}>
                      {office.type}
                    </p>
                  </div>
                </li>
        ...
        <div
          className={`mt-12 pt-8 border-t ${
            isStartupsPage ? "border-purple-500/30" : "border-blue-500/30"
          }`}
        >
